<nav class="col-md-2 d-none d-md-block bg-light sidebar">
    <div class="media justify-content-center">
      <img src="<?= img_profile(getUser($_SESSION['id'])['img_path'])?>" width="100" height="100" class="img-thumbnail rounded-circle"
      alt="John Thor">
    </div>
    <div class="sidebar-sticky">
      <ul class="nav flex-column">
        <li class="nav-item">
          <a class="nav-link active" href="<?= base_url('User/'.getUser($_SESSION['id'])['username'])?>">
