...
$route['User/(:any)/ticket']  = "Ticket/userTicket";
$route['User/(:any)/address']  = "Address/userAddress";
$route['User/(:any)/wishlist']  = "Wishlist/index";
$route['User/(:any)/update']  = "User/updateProfile";
$route['bestseller'] ="Product/topsell";
$route['checkemail']  = "User/checkEmail";
$route['admin/useradmin']  = "admin/User/listUser";
